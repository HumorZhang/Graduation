...
//         导出操作
    ...
    public String importExcel(@RequestParam("file") MultipartFile file) {
        ...
        try {
            ...
            List<Equipment> successList = ExcelImportUtil.importExcel(file.getInputStream(), Equipment.class, importParams);
            // 设置对象的默认值
            ...
            for (Equipment equipment : successList) {
                ...
                equipmentService.insertOne(equipment);
        ...
        return "redirect:/index#equipments";
    }
